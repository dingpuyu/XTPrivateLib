#
#  Be sure to run `pod spec lint XTProtocolManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "这是一个组件管理工具 XTProtocolManager."
  ...
  s.author             = { "dingpuyu" => "771005227@qq.com" }
  # Or just: s.author    = "dingpuyu"
  # s.authors            = { "dingpuyu" => "771005227@qq.com" }
